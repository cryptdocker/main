		...
		<motion.div
			...
			<div className="relative z-10">
				<div className="flex items-start justify-between mb-5">
					<div className="w-12 h-12 rounded-xl bg-linear-to-br from-violet-500/20 to-cyan-500/20 text-violet-400 flex items-center justify-center group-hover/card:shadow-lg group-hover/card:shadow-violet-500/10 transition-all duration-300">
						{icon}
					</div>
					{tip && (
